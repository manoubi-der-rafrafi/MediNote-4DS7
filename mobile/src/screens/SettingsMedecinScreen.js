// ─── screens/SettingsMedecinScreen.js — Doctor Profile & Settings ───────────
...
import { SectionLabel, Card, Pill } from '../components/medecin';

export default function SettingsMedecinScreen({ navigation, onLogout }) {
  ...
  return (
    <SafeAreaView style={s.safe}>
      <ScrollView style={s.scroll} contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
        ...
        {/* Profile Card */}
        <SectionLabel title="Profil Médecin" />
        <Card>
          ...
          <Card>
            ...
            <TouchableOpacity style={[s.settingRow, { marginTop: spacing.md }]}>
              ...
              <Switch
                ...
                trackColor={{ false: colors.s3, true: colors.teal }}
                thumbColor={security.twoFactorEnabled ? colors.teal : colors.t2}
              />
            </TouchableOpacity>
          </Card>
        )}
        ...
        <Card>
          <TouchableOpacity style={s.settingRow}>
            ...
            <Switch
              ...
              trackColor={{ false: colors.s3, true: colors.teal }}
              thumbColor={notifications.emailAlerts ? colors.teal : colors.t2}
            />
          </TouchableOpacity>
          <TouchableOpacity style={[s.settingRow, { marginTop: spacing.md }]}>
            <View>
            ...
            <Switch
              ...
              trackColor={{ false: colors.s3, true: colors.teal }}
              thumbColor={notifications.pushNotifications ? colors.teal : colors.t2}
            />
          </TouchableOpacity>
          <TouchableOpacity style={[s.settingRow, { marginTop: spacing.md }]}>
            <View>
            ...
            <Switch
              ...
              trackColor={{ false: colors.s3, true: colors.teal }}
              thumbColor={notifications.weeklyReport ? colors.teal : colors.t2}
            />
          </TouchableOpacity>
        </Card>
...
const s = StyleSheet.create({
  ...
  avatarLarge:    { width: 64, height: 64, borderRadius: 32, backgroundColor: colors.tealB, borderWidth: 2, borderColor: colors.teal, alignItems: 'center', justifyContent: 'center' },
  avatarText:     { fontSize: font.xxl },
  changeAvatarText: { color: colors.teal, fontSize: font.xs, marginTop: 4, fontWeight: '600', textAlign: 'center' },
  ...
  statValue:      { color: colors.teal, fontSize: font.base, fontWeight: '700' },
