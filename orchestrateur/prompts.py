...
8. Si la demande concerne la generation d'un rapport de taches, conversations, messages, publications, ou rapports structures:
{
  "intent": "task_report",
  "action": "generate_report",
  "report_type": "tasks" | "conversations" | "messages" | "publications" | "rapports" | "full",
  "user_id": int | null,
  "conversation_id": int | null,
  "format": "markdown" | "json"
}

9. Si la demande concerne l'exportation d'un rapport en PDF:
{
  "intent": "pdf_export",
  "action": "export_to_pdf",
  "report_type": "tasks" | "conversations" | "publications" | "rapports" | "full",
  "format": "pdf",
  "response_language": "Arabic" | "French" | "English"
}
...
- Utiliser `intent="task_report"` si la demande demande un rapport, un resume, une liste, ou un export des taches, conversations, messages, publications, ou rapports structures. Exemples: "donne moi un rapport des tâches", "génère un rapport des conversations", "liste mes publications", "exporte les rapports structurés", "fais un rapport complet".
- Utiliser `intent="pdf_export"` si la demande demande explicitement d'exporter, sauvegarder en PDF, ou télécharger un rapport. Exemples: "exporte en PDF", "génère un PDF", "télécharge le rapport", "exporte le rapport en PDF".
""".strip()
