      ...
      <div ref={ref} className="bg-s1 rounded-lg overflow-hidden border border-bd">
        ...
        <div className="p-4 border-b border-bd">
          <input
            ...
            className="w-full px-3 py-2 bg-s2 border border-bd rounded text-sm text-white placeholder-gray-500 focus:outline-none focus:border-manager"
          />
        </div>
                ...
                <tr>
                  <td colSpan={columns.length} className="px-4 py-8 text-center">
                    <div className="flex justify-center items-center gap-2">
                      <div className="w-2 h-2 bg-manager rounded-full animate-pulse" />
